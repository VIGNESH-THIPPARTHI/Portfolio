    ...
    <Nav>
      <NavbarContainer>
        ...
        <ButtonContainer>
          ...
          <SocialMediaButtons href="https://www.linkedin.com/in/vignesh-thipparthi/" target="_blank"><LinkedInIcon/></SocialMediaButtons>
        ...
        </ButtonContainer>
        {
          ...
          <MobileMenu isOpen={isOpen}>
            ...
            <SocialMediaButtons style={{ marginLeft:'-9px',color: 'white', width: 'max-content',fontWeight: '500',fontSize:'16px' }} href="https://www.linkedin.com/in/vignesh-thipparthi/" target="_blank">LinkedIn</SocialMediaButtons>
